...
### Create the environment with the `environment-dev.yml` file

Conda allows you to automate the environment creation with an `environment-dev.yml` file.
...
In the top level directory of this repository, where the `environment-dev.yml` file is located, run the following from your command line.
...
## Inspecting the `dataframe.py` File

You will be editing a single file for this project - the `dataframe.py` file
